...
- [ ] **Step 1: 安装 drawio-skill**

```bash
npx skills add Agents365-ai/365-skills -g
```

- [ ] **Step 2: 验证 draw.io CLI 可用**
...
- [ ] **Step 1: 更新 description 元数据 — 将 `diagrams library` 改为 `drawio-skill`**
...
- [ ] **Step 2: 更新 metadata 添加 drawio-skill 依赖声明**
...
- [ ] **Step 3: 更新 Pre-1.2 依赖检测 — 移除 `diagrams`，新增 wewrite + drawio-skill + draw.io CLI 检测**
...
- [ ] **Step 4: 更新 WeChat Image Rule 规则**
...
- [ ] **Step 2: 替换 Pre-3.4 确认流程 — 改为 drawio-skill 迭代反馈模式**
...
- [ ] **Step 4: 更新引用参考 — 添加 drawio-skill 引用**
...
- [ ] **Step 1: 更新 install.ps1 — 在文件末尾添加 drawio-skill 安装和 draw.io CLI 检测**
...
- [ ] **Step 2: 更新 install.sh — 在文件末尾添加 drawio-skill 安装和 draw.io CLI 检测**
...
- [ ] **Step 1: 更新 references/complete-flow.md — Pre-1 依赖行**
...
- [ ] **Step 2: 更新 references/complete-flow.md — Pre-3.3 配图执行**
...
- [ ] **Step 3: 更新 references/complete-flow.md — Pre-3.4 确认流程**
...
- [ ] **Step 4: 更新 AGENTS.md — Pipeline 表**
...
- [ ] **Step 5: 更新 AGENTS.md — WeChat Image Rule**
...
- [ ] **Step 6: 更新 AGENTS.md — Key Scripts**
